 $(function() {
	...
	function dynamic(filter_status_pembayaran, filter_status_pengiriman, filter_tanggal_mulai, filter_tanggal_akhir, filter_vendor){
		//initialize responsive datatable
	...
	$('#filter-cari').click(function() {
		...
		let filter_vendor = $("#filter_vendor").val();
		$("#advanced-usage").dataTable().fnDestroy();
		$.message('Pencarian Berhasil.','Laporan Penjualan','success');
		dynamic(filter_status_pembayaran, filter_status_pengiriman, filter_tanggal_mulai, filter_tanggal_akhir, filter_vendor);
	});
	// // fungsi simpan 
