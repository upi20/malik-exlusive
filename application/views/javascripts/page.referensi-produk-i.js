 $(function() {
	...
	var table4 = $('#advanced-usage').DataTable({
		...
		"columns": [
			...
			{ "data": "prod_berat" },
			{ "data": "prod_special" },
			// { "data": "prod_link_referensi" },
			// {
			// 	"data": "prod_link_referensi", render: function(data, type, full, meta)
			// 	{
			// 		var strArray = data.split("|");
			// 		var tampung = '';
			// 		// return 's'
   		//      			for(var i = 0; i < strArray.length; i++){
			// 			tampung += "<a target='_BLANK' href='"+strArray[i]+"'>" + strArray[i] + "</a> <br>";
			// 		}
			// 		return tampung;
			// 	}
			// },
	...
	function dynamic(val_kategori_utama=null, val_kategori=null, val_sub_kategori=null, val_rak=null, val_etalase=null, val_vendor=null, val_status_stok=null){
		...
		var table4 = $('#advanced-usage').DataTable({
			...
			// 	"data": "prod_min_stok", render: function(data, type, full, meta)
			// 	{
			// 		return '<button style="color: blue;background-color: Transparent;background-repeat:no-repeat;border: none;cursor:pointer;overflow: hidden;outline:none;float: right;text-align: right;" class="min-stok-button" data-toggle="modal" data-target="#splash-10" data-options="splash-10 splash-ef-14" value="'+full.prod_id+'">'+data+'</button>';						
			// 	}
			// },
			// {
			// 	data: "prod_min_stok", render: function(data, type, full, meta)
