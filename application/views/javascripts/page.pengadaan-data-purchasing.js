		...
		"ajax": {
			...
			"columns": [
				...
				{ "data": "peng_status_manager" },
				{
					...
					{
						if(full.peng_status_purchasing == 'menunggu'){
							return '<a style="float:right;" href="<?=base_url()?>pengadaan/data/proses/terima/'+full.peng_id+'/purchasing" class="btn btn-xs btn-primary">Terima</a><a style="float:right;" href="<?=base_url()?>pengadaan/data/proses/tolak/'+full.peng_id+'/purchasing" class="btn btn-xs btn-warning">Tolak</a>';
						}else{
							return '<a style="float:right;" href="<?=base_url()?>pengadaan/data/cetak/'+full.peng_id+'" class="btn btn-sm btn-default"><i class="fa fa-print"></i> Cetak</a> <!-- <a style="float:right;" href="<?=base_url()?>pengadaan/data/detail/'+full.peng_id+'" class="btn btn-xs btn-success">Detail</a> --!>';
						}
					}
				},
			],
