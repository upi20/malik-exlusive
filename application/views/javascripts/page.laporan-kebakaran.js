$(function() {
	...
	$('#dt_basic').DataTable({
	    ...
	    "serverSide": true,
	    ajax: {
				url: "<?= base_url()?>laporan/kebakaran/ax_data_isi/",
				data: null,
				type: 'POST'
			},
			columns: [
	      ...
	      { data: "lapo_keterangan" },
	      {
					data: "lapo_id", render: function(data, type, full, meta)
					{
						return '<div class="pull-right">'
											+'<a href="<?=base_url()?>laporan/CetakKebakaran/cetak_kebakaran/'+data+'"><button class="btn btn-xs btn-default value="'+data+' " ><i class="fa fa-print"></i>Print</button></a>'
										+'</div>';
					}
				},
			],
