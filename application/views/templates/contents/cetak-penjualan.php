...
<body>
  <div class="container">
    <div class="page-header text-center">
      <h4>Faktur Penjualan<br></h4>
    </div>
    <div class="row">
      <div class="col-md-6">
        <small>Nama: <?=$lapor['penj_nama']?></small><br>
        <small>No. HP: <?=$lapor['penj_no_hp']?></small><br>
      </div>
      <div class="col-md-6">
        <small>Alamat: <?=$lapor['penj_alamat']?></small><br>
        <small>Status: <?=$lapor['penj_status']?></small><br>
      </div>
    </div>
      ...
      <tbody>
        <?php foreach($produk as $p):?>
          <tr>
            <td><?=$p['prod_kode']?></td>
            <td><?=$p['prod_nama']?></td>
            <td style="text-align: right;"><?=$this->libs->rupiah_non($p['pede_harga'])?></td>
            <td style="text-align: right;"><?=$p['pede_jumlah']?></td>
            <td style="text-align: right;"><?=$this->libs->rupiah_non($p['pede_total_harga'])?></td>
          </tr>
        <?php endforeach;?>
      </tbody>
    </table><br><br>
    <div class="pull-left">
      <small>Diprint oleh : <br>
      Pada tanggal : <?=$lapor['penj_tanggal']?></small>
    </div>
    <div class="pull-right">
      <p>Palembang, <?php echo date('d M Y');?><br>
