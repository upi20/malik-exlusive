...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="<?=base_url()?>resetPassword/reset/<?=$kode?>" id="login-form" class="smart-form client-form" method="POST">
								<header>
									Reset Password
								</header>
								...
								<fieldset>
									...
									<section>
										<label class="label">Masukan Password Baru</label>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
	    ...
	    <script src="<?= base_url() ?>assets///ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$("#login-form").validate({
					...
					messages : {
						email : {
							required : 'Please enter your email address or nip',
							email : 'Please enter a VALID email address or nip'
						},
						password : {
