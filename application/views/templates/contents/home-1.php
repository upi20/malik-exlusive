					...
					<div class="row">
						...
						<div class="card-container col-lg-4 col-sm-6 col-sm-12">
                            ...
                            <section class="tile tile-simple tbox">
                                ...
                                <a href class="myIcon icon-drank icon-ef-8 icon-color"><i class="fa fa-plus"></i></a>
                                </div>
                                <!-- /tile widget -->
                                ...
                                <div class="tile-body text-center tcol">
                                    <br>
									<p style="center">
									<h4 class="m-0"><?=$this->libs->rupiah_non($total_nominal_pengadaan)?></h4>
                                    <span class="text-muted">Total Pengadaan</span>
									</p>
						...
						<div class="card-container col-lg-4 col-sm-6 col-sm-12">
                            ...
                            <section class="tile tile-simple tbox">
                                ...
                                <a href class="myIcon icon-drank icon-ef-8 icon-color"><i class="fa fa-arrow-down"></i></a>
                                </div>
                                <!-- /tile widget -->
                                ...
                                <div class="tile-body text-center tcol">
                                    <br>
									<p style="center">
									<h4 class="m-0"><?=$total_barang_terjual?></h4>
                                    <span class="text-muted">Total Barang Terjual</span>
									</p>
