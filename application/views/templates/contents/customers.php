	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title custom-font" id="myModalLabel">Form Customers</h3>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="perusahaan" placeholder="Masukan perusahaan" required="">
							</div>
						</div>
					</div>
					<div class="row">
