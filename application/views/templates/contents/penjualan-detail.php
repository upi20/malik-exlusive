								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="nama" name="nama" required="" value="<?=$detail['penj_nama']?>" readonly>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">No Hp Pembeli</label>
											<input type="number" class="form-control" id="no_hp" name="no_hp" required="" value="<?=$detail['penj_no_hp']?>" readonly>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Alamat Pembeli</label>
											<textarea class="form-control" id="alamat" readonly name="alamat" required=""><?=$detail['penj_alamat']?></textarea>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Kurir</label>
											<select class="form-control" name="kurir" id="kurir" disabled="true">
										...
										<div class="form-group">
											...
											<input type="number" value="<?=$detail['penj_ongkir']?>" class="form-control" id="ongkir" name="ongkir" value="0" readonly="">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="exampleInputEmail1">ID Transaksi (Marketplace)</label>
											<input type="text" readonly class="form-control" id="id_marketplace" name="id_marketplace" value="<?=$detail['penj_id_marketplace']?>">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Tanggal</label>
											<input type="date" class="form-control" id="tanggal" name="tanggal" required="" value="<?=$detail['penj_tanggal']?>" readonly>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Tanggal Pengiriman</label>
											<input type="date" class="form-control" name="tanggal_pengiriman" id="tanggal_pengiriman" value="<?=$detail['penj_tanggal_pengiriman']?>" readonly>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Sumber Penjualan</label>
											<input type="text" class="form-control" name="supe_nama" id="supe_nama" value="<?=$detail['supe_nama']?>" readonly>
										</div>
										<div class="form-group">
											<label for="exampleInputEmail1">Keterangan</label>
											<textarea class="form-control" id="keterangan" name="keterangan" required="" readonly=""><?=$detail['penj_keterangan']?></textarea>
										</div>
									</div>
									<div class="col-md-6">
