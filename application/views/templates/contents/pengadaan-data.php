						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									...
									<a style="float: right;" class="btn btn-ef btn-ef-5 btn-ef-5b btn-success mb-10" href="<?= base_url() ?>pengadaan/tambah"><i class="fa fa-plus"></i> <span>Tambah</span></a>
									<?php if ($this->level == "Recording") : ?>
										<a style="float: right;" class="btn btn-ef btn-ef-5 btn-ef-5b btn-primary mb-10" target="_BLANK" href="<?= base_url() ?>produk/export_excel"><i class="fa fa-plus"></i> <span>Export Excel</span></a>
									<?php endif; ?>
