...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<!-- <span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<?=base_url()?>assets/register.html" class="btn btn-danger">Creat account</a> </span> -->
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">Aplikasi Sikardu</h1>
						<div class="hero">

							<div class="pull-left login-desc-box-l">
								<h4 class="">Sebuah aplikasi Sistem Kebakaran Terpadu (SIKARDU) yang memenejemnkan informasi secara realtime informasi sumber kebakaran dan permasalahan kejadian pertolongan yang dilakukan oleh Pemadam Kebakaran (DAMKAR) ada di lingkungan Kabupaten Garut yang terpadu secara smart dan integrasi dengan Geografi Information System (GIS) untuk mendapatkan data dna informasi sebagai pengambil keputusan yang cepat, akurat, dan solutif.</h4>
							</div>
							
							<img src="<?= base_url() ?>assets/img/androidview.png" class="pull-right display-image" alt="" style="width:210px">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="<?=base_url()?>lupaPassword/reset" id="login-form" class="smart-form client-form" method="POST">
								<header>
									Lupa Password
								</header>
	    ...
	    <script src="<?=base_url()?>assets///ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
