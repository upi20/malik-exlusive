...
class CetakKebakaran_model extends CI_Model {
	...
	public function get_lapor()
    {
		...
		public function getLapor($id){
			$sql = "select a.*,b.*,c.keja_nama,d.regu_nama, f.refs_id, f.refs_nama, f.refs_keterangan, a.created_date,b.lapa_waktu_selesai,g.*
