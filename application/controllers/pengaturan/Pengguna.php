...
class Pengguna extends Render_Controller {
	...
	public function ajax_data()
	{
		...
		$data 	= $this->pengguna->getAllIsi($length, $start, $_cari, $lev_id)->result_array();
		$count 	= $this->pengguna->getAllIsi(null,null, $_cari, $lev_id)->num_rows();
		array($cari);
	...
	public function update() {
		...
		$r = $this->pengguna->update($id, $email, $name, $phone, $address, $lev_id);
