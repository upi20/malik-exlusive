...
class Pembayaran extends Render_Controller {
	...
	public function index() {
		// Page config:
		$this->title = 'Penjualan Pembayaran';
		$this->content = 'penjualan-pembayaran'; 
	...
	public function ajax_data()
	{
		...
		$data 	= $this->penjualan->getPembayaran($length, $start, $cari['value'])->result_array();
		$count 	= $this->penjualan->getPembayaran(null,null, $cari['value'])->num_rows();
		array($cari);
