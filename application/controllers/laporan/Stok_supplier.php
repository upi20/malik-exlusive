...
class Stok_supplier extends Render_Controller
{
	...
	public function index()
	{
		...
		$this->data['data'] = $this->getAllData();
		// Commit render:
		$this->render();
	}
	...
	{
		$data['title'] = "Laporan supplier stok";
		$data['data'] = $this->getAllData();
		$this->load->view('templates/cetak/laporan_stok_supplier', $data);
	}


	private function getAllData()
	{
		return $this->db->select('a.*, b.prod_nama, c.supp_nama')
			->from('produk_stok a')
